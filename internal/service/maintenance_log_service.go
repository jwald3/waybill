...
func (s *maintenanceLogService) List(ctx context.Context, limit, offset int64) ([]*domain.MaintenanceLog, error) {
	maintenanceLogs, err := s.maintenanceLogRepo.List(ctx, limit, offset)
